      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-500">
              Enter a rough instruction and PromptForge will turn it into a
        ...
        <div className="relative mt-7">
          <textarea
            ...
            className="
              min-h-48 w-full resize-y rounded-2xl
              border border-white/[0.08] bg-black/30
              p-5 pr-14 text-base leading-7 text-white
        ...
        <div className="mt-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <p className="text-sm text-zinc-500">
            Your Gemini API key stays securely inside the backend.
          </p>
